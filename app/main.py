...
async def vehicle_profile_delete(
    ...
    # فقط حافظه پیشنهاد حذف می‌شود.
    # قبض‌های قبلی دست نخورده می‌مانند.
    conn = db()
...
async def create_weighment(
    ...
    # جلوگیری از دو پرونده باز برای یک پلاک
